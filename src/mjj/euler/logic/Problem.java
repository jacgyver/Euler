...
// 2014-05-22
	...
	long problem002() {
		...
		pEnd = System.currentTimeMillis();
		System.out.println("This soluntion of problem002 is " + solution + " -- " + (pEnd-pBegin) + " ms");
		return solution;
	}
	...
	long problem003() {	
		...
		pEnd = System.currentTimeMillis();
		System.out.println("This soluntion of problem003 is " + solution + " -- " + (pEnd-pBegin) + " ms");
	...
	long problem004() {	
		...
		solution = max;
		pEnd = System.currentTimeMillis();
		System.out.println("This soluntion of problem004 is " + solution + " -- " + (pEnd-pBegin) + " ms");
		return solution;
	}		
 ...
 */
	long problem028() {	
		...
		for (int i=0;i<X;i++) {
			for(int j=0;j<Y;j++) {
				if (i==j || (X-1-i) == j) solution = solution + al[i][j]; 
			}
		}
 ...
 */	
	...
	long problem033() {	
		...
		pEnd = System.currentTimeMillis();
		System.out.println("This soluntion of problem033 is " + solution + " -- " + (pEnd-pBegin) + " ms");
	...
	long problem035() {	
		...
		pEnd = System.currentTimeMillis();
		System.out.println("This soluntion of problem035 is " + solution + " -- " + (pEnd-pBegin) + " ms");
